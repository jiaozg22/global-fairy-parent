package org.global.fairy.cms.admin.interceptor;
...
public class TimeInterceptor{
    ...
    public static final String POINT = "execution (* org.global.fairy.cms.admin..*(..))";
//    // controller层的统计耗时切面，类型必须为final String类型的,注解里要使用的变量只能是静态常量类型的
//    public static final String CONTROLLER_POINT = "execution (* org.global.fairy.cms.admin.controller.*.*(..))";
//    // service层的统计耗时切面，类型必须为final String类型的,注解里要使用的变量只能是静态常量类型的
//    public static final String SERVICE_POINT = "execution (* org.global.fairy.cms.admin.service.*.*(..))";
//    // dao层的统计耗时切面，类型必须为final String类型的,注解里要使用的变量只能是静态常量类型的
//    public static final String DAO_POINT = "execution (* org.global.fairy.cms.admin.dao.*(..))";
